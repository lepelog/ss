...
adapted from https://github.com/SeekyCt/spm-decomp/blob/master/configure.py
"""
...
# Check CW was added
assert os.path.exists("tools/codewarrior/1.3/mwcceppc.exe") and \
       os.path.exists("tools/codewarrior/1.3/mwldeppc.exe"), \
       "Error: Codewarrior not found in tools/codewarrior/1.3/"
...
# TODO: Check binaries are correct idk the correct hashes atm.
...
#     c.DOL_LCF,
#     rule="forceactivegen",
#     inputs=[c.DOL_LCF_TEMPLATE, c.DOL_YML, c.DOL_LABELS, c.GAME_SYMBOLS]
# )
