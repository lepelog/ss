...
adapted from https://github.com/SeekyCt/spm-decomp/blob/master/common.py
"""
...
# Codewarrior
TOOLS = "tools"
CODEWARRIOR = os.path.join(TOOLS, "codewarrior", "1.3")
...
# Binaries
DOL = f"{ORIG}/dol/main.dol" # read in python code
